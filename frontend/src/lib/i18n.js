...
const _dicts = {
  zh: {
    ...
    "page.settings": "设置",
    // 阶段一新增中心页
    "page.mktstructure": "市场结构",
    "page.strategy_hub": "策略工场",
    "page.factor_hub": "因子研究",
    "page.automation": "信号与自动化",
    "page.datacenter": "数据中心",
    "page.audit_recon": "审计对账",
    // 分组（菜单树）
    "group.dashboard": "总览",
    "group.market": "行情",
    "group.trade": "交易",
  ...
  en: {
    ...
    "page.mktstructure": "Market Structure",
    "page.strategy_hub": "Strategy Hub",
    "page.factor_hub": "Factor Research",
    "page.automation": "Signals & Automation",
    "page.datacenter": "Data Center",
    "page.audit_recon": "Audit & Reconcile",
    ...
    "tree.行情": "Market",
    "tree.交易": "Trading",
    "tree.组合与策略": "Portfolio & Strategy",
    "tree.研究": "Research",
    "tree.选股与信号": "Screener & Signals",
    "tree.系统运维": "System Ops",
  },
};
