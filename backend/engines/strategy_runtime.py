    ...
    async def _eval_limitup(self, run, bridge, codes, params) -> None:
        ...
        for code in codes:
            ...
            try:
                ...
                continue
            # P1-6：复用统一涨停判定 engines.limitup._limit_factor（主板10/创业科创20/北交30/ST5），
